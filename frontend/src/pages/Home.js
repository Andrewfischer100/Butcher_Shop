    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (formType === 'login') {
                ...
                localStorage.setItem('token', response.data.token); // Save the token like in login
                localStorage.setItem('username', response.data.username); // Save username too if necessary
